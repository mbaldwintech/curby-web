...
export const fetchUrgentItems = createAsyncThunk<ExtendedItem[], void, { rejectValue: string; extra: AdminExtra }>(
...
export const fetchUrgentItemsCount = createAsyncThunk<number, void, { rejectValue: string; extra: AdminExtra }>(
